...
>This section is only for those who which to manually configure the Keycloak server.
...
Enter any one of the username and password combination created earlier to sign in. After a successful login you will see the product catalog page:
